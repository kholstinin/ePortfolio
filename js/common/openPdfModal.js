...
export default function openWorks(paths: Array<string>): void {
  ...
  const win = new BrowserWindow(
      {parent: parentWin, modal: true, width: widthOfWindow, height: heightOfWorkWindow});
